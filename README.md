...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/r-dtangle-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=7603&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-dtangle-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-dtangle` can be installed with:

```
conda install r-dtangle
```

It is possible to list all of the versions of `r-dtangle` available on your platform with:
